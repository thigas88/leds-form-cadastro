$(document).ready(function() {
	...
	//=================================== hover global oportunities  =================================//
	function hoverOffset() {
		var contHeight = $('.global-oportunities .item .cont').height();
		var titleHeight = $('.global-oportunities .item .cont h3').height();
		var contOffset = contHeight - titleHeight;
		$('.global-oportunities .item .cont').css("top", contOffset + "px");
	}
